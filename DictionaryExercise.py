...
# and probably some good looking girl or boy you want to marry. All prices in gold pieces excl. VAT... chop chop!! ze germanz are coming!
...
#Ver 1.5 print inventory before and after purchases as one department_store of stuff(combine inventories from all stores into one...
# pretend Big Biz bought all the local stores, and want constant reporting for inventory management...)
# as in all games there is a special way to do this that actually makes money and solves the problem...can you find 'them'? 
# Do you know why? May require knowledge of actual python 'lore'
...
print(f'You Purchased {list(cart.keys())} Today it is all free. Have a nice day of mayhem!')# test without the list and see the result!
#convert the items into a normal string instead of list or something else:
